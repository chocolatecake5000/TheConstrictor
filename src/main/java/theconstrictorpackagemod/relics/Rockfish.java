...
public class Rockfish extends BaseRelic {
    private static final String NAME = "Rockfish"; //The name will be used for determining the image file as well as the ID.
