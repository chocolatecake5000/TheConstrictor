...
public class ConstrictorAchievementItem extends AchievementItem {
    ...
    public ConstrictorAchievementItem(String title, String desc, String key, boolean hidden, TextureAtlas.AtlasRegion unlockedImage, TextureAtlas.AtlasRegion lockedImage) {
