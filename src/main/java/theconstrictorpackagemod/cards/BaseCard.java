...
import static theconstrictorpackagemod.util.TextureLoader.getCardTextureString;
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    theconstrictormod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
